...
[source,powershell]
----
# Max performance, when use this options other options is not required
fsutil devdrv enable /disallowAv
# Check if the defender disabled
fsutil devdrv query D: 

# make trusted folder for async scanning 
fsutil devdrv trust d:

# Exlude folders from scanning
...
[source,powershell]
----
"D:\nuget-cache\packages","D:\nuget-cache\http-cache","D:\nuget-cache\scratch","D:\nuget-cache\plugins-cache" | ForEach-Object { New-Item -ItemType Directory -Path $_ -Force | Out-Null }
