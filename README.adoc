...
== 3. When to Install Developer Tools on Dev Drive
...
== 4. Create and Configure Dev Drive

=== 4.1 Create Dev Drive (Windows UI)
...
=== 4.2 Configure Microsoft Defender Performance Mode (Optional)
...
Optionally place portable SDKs in:
...
=== 6.2 Redirect NuGet Global Packages Folder
...
[source,powershell]
----
setx NUGET_PACKAGES "D:\dev\nuget-cache"
----

Restart all terminals or reboot.
...
=== 6.3 Optional: Redirect NuGet HTTP Cache

[source,powershell]
----
setx NUGET_HTTP_CACHE_PATH "D:\dev\nuget-cache\http"
----

== 7. Configure JetBrains Rider
...
=== 7.2 Rider Cache Locations (Optional)
...
== 8. Package Cache (Visual Studio / Build Tools)
...
== 9. Microsoft Defender Exclusions (Alternative to Disabling Filters)
